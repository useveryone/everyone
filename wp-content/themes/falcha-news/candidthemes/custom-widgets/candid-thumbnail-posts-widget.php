 ...
 * @since 1.0.0
 */
if (!class_exists('Falcha_News_Thumb_Posts')) :
     ...
     * @since 1.0.0
     */
    class Falcha_News_Thumb_Posts extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title' => esc_html__('Thumbnail Posts', 'falcha-news'),
                'cat' => 0,
                'post-number' => 6,
        ...
        {
            $opts = array(
                'classname' => 'falcha-news-thumbnail-post',
                'description' => esc_html__('Help to display content in thumbnail image Layout.', 'falcha-news'),
            );

            parent::__construct('falcha-news-thumbnail-post', esc_html__('Falcha News Thumbnail Post', 'falcha-news'), $opts);
        }
                                ...
                                <div class="list-post">
                                    <div class="post-block-style">
                                        ...
                                        if (has_post_thumbnail()) {
                                            ...
                                            <div class="post-thumb">
                                                <a href="<?php the_permalink(); ?>">
                                                    <img src="<?php echo esc_url(get_template_directory_uri()) . '/candidthemes/assets/images/falcha-mag-thumb.jpg' ?>"
                                                         alt="<?php the_title(); ?>">
                                                </a>
                                            </div><!-- Post thumb end -->
                                        <?php }
