...
/**
 * Falcha News Featured Post Widget.
 *
 * @since 1.0.0
 */
if (!class_exists('Falcha_News_Featured_Post')) :
     ...
     * @since 1.0.0
     */
    class Falcha_News_Featured_Post extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title' => esc_html__('Popular News', 'falcha-news'),
                'cat' => 0,
                'post-number' => 5,
            );
            return $defaults;
        ...
        {
            $opts = array(
                'classname' => 'falcha-news-featured-post',
                'description' => esc_html__('Displays Featured Post in Home Page. Place it in Home Widget Area Top.', 'falcha-news'),
            );

            parent::__construct('falcha-news-featured-post', esc_html__('Falcha News Featured Post', 'falcha-news'), $opts);
        }
...
?>
                                ...
                                <section class="ct-grid-post-list">
                                    ...
                                    <div class="post-content mt-10">
                                        ...
                                        <div class="post-excerpt">
                                            <?php echo falcha_news_excerpt_words(get_the_ID(), absint(25)); ?>
                                        </div>
        ...
        function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post-number')); ?>"><?php esc_html_e('Number of Posts to Display:', 'falcha-news'); ?></label>
