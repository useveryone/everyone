 ...
 */
if (!function_exists('falcha_news_get_microdata')) :
    function falcha_news_get_microdata($context)
    {
        $data = false;

        if ('microdata' !== apply_filters('falcha_news_schema_type', 'microdata')) {
            return false;
        }
        ...
        if ('body' === $context) {
            ...
            $type = apply_filters('falcha_news_body_itemtype', $type);
        ...
        if ('article' === $context) {
            $type = apply_filters('falcha_news_article_itemtype', 'CreativeWork');
        ...
        if ($data) {
            return apply_filters("falcha_news_{$context}_microdata", $data);
        }
    }
endif;
 ...
 */
if (!function_exists('falcha_news_do_microdata')) :
    function falcha_news_do_microdata($context)
    {
        echo falcha_news_get_microdata($context); // WPCS: XSS ok, sanitization ok.
    }
endif;